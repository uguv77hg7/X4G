...
:root{--bg:#0B0E17;--bg2:#111827;--bg3:#1F2937;--card:rgba(17,24,39,0.8);--card-b:rgba(0,255,136,0.12);--card-bh:rgba(0,255,136,0.3);--accent:#00FF88;--accent2:#00CC6A;--accent-d:rgba(0,255,136,0.1);--blue:#0066FF;--green:#00FF88;--red:#FF4444;--red-bg:rgba(255,68,68,0.1);--t1:#F0F4F8;--t2:#9CA3AF;--t3:#6B7280}
[data-theme="light"]{--bg:#F8FAFC;--bg2:#F1F5F9;--bg3:#E2E8F0;--card:rgba(255,255,255,0.9);--card-b:rgba(0,204,106,0.15);--card-bh:rgba(0,204,106,0.3);--accent:#00CC6A;--accent2:#009950;--accent-d:rgba(0,204,106,0.08);--green:#00AA55;--red:#DD2222;--red-bg:rgba(221,34,34,0.08);--t1:#0F172A;--t2:#475569;--t3:#94A3B8}
html,body{height:100%;overflow:hidden}
body{font-family:'Vazirmatn',sans-serif;background:var(--bg);display:flex;align-items:center;justify-content:center;padding:20px;transition:background .3s}
.blob{position:fixed;border-radius:50%;filter:blur(120px);z-index:0;animation:blobFloat 12s ease-in-out infinite;pointer-events:none}
.blob-g{width:500px;height:500px;background:rgba(0,255,136,0.06);top:-150px;right:-120px}
.blob-b{width:400px;height:400px;background:rgba(0,102,255,0.05);bottom:-100px;left:-100px;animation-delay:6s}
@keyframes blobFloat{0%,100%{transform:translate(0,0)}33%{transform:translate(30px,-20px)}66%{transform:translate(-20px,30px)}}
@keyframes float{0%,100%{transform:translateY(0)}50%{transform:translateY(-12px)}}
@keyframes spin{to{transform:rotate(360deg)}}
@keyframes breathe{0%,100%{transform:scale(1);opacity:.5}50%{transform:scale(1.08);opacity:0}}
.wrap{position:relative;z-index:10;width:100%;max-width:400px;animation:float 6s ease-in-out infinite}
.card{background:var(--card);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:24px;padding:40px 36px 36px;box-shadow:0 0 60px rgba(0,255,136,0.05),0 20px 60px rgba(0,0,0,.5);transition:border-color .3s,box-shadow .3s}
.card:hover{border-color:var(--card-bh);box-shadow:0 0 80px rgba(0,255,136,0.1),0 20px 60px rgba(0,0,0,.5)}
.brand{display:flex;align-items:center;gap:14px;margin-bottom:30px;justify-content:center}
.brand-img{width:56px;height:56px;border-radius:50%;overflow:hidden;border:1.5px solid var(--card-bh);box-shadow:0 0 24px rgba(0,255,136,0.25),0 0 12px rgba(0,102,255,0.2);flex-shrink:0;animation:breathe 3s ease-in-out infinite}
.brand-img img{width:100%;height:100%;object-fit:cover}
.brand-name{font-size:20px;font-weight:800;color:var(--t1);letter-spacing:-.02em}
.brand-sub{font-size:11px;color:var(--accent);margin-top:2px;font-weight:600}
h1{font-size:22px;font-weight:700;color:var(--t1);margin-bottom:6px;letter-spacing:-.02em;text-align:center}
.sub{font-size:12px;color:var(--t2);margin-bottom:26px;line-height:1.6;text-align:center}
.hint{display:flex;align-items:center;gap:10px;background:var(--accent-d);border:1px solid var(--card-b);border-radius:14px;padding:10px 14px;margin-bottom:22px}
.hint-label{font-size:11px;color:var(--t2);flex:1}
.hint-val{font-family:ui-monospace,monospace;font-size:14px;font-weight:700;color:var(--accent);background:rgba(0,255,136,0.08);border:1px solid var(--card-b);padding:3px 11px;border-radius:7px;cursor:pointer;transition:.15s;letter-spacing:.08em}
.hint-val:hover{background:rgba(0,255,136,0.15);border-color:var(--card-bh)}
.field{margin-bottom:20px}
.field label{display:block;font-size:10.5px;font-weight:600;color:var(--t2);margin-bottom:7px;text-transform:uppercase;letter-spacing:.06em}
.inp-wrap{position:relative}
input[type=password]{width:100%;padding:14px 44px 14px 16px;border-radius:12px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:14px;outline:none;transition:.3s;backdrop-filter:blur(10px)}
input[type=password]:focus{border-color:var(--accent);background:rgba(0,0,0,.3);box-shadow:0 0 0 3px rgba(0,255,136,0.1),0 0 20px rgba(0,255,136,0.05)}
input[type=password]::placeholder{color:var(--t3)}
.ic{position:absolute;left:14px;top:50%;transform:translateY(-50%);color:var(--t3);font-size:18px;pointer-events:none;transition:.3s}
input:focus+.ic{color:var(--accent)}
.err{display:none;background:var(--red-bg);border:1px solid rgba(255,68,68,0.2);border-radius:12px;padding:10px 14px;margin-bottom:14px;font-size:12px;color:var(--red);align-items:center;gap:8px}
.err.show{display:flex}
.btn{width:100%;padding:14px;border-radius:50px;border:none;cursor:pointer;background:linear-gradient(135deg,var(--accent),#00CC6A);color:#0B0E17;font-family:inherit;font-size:14px;font-weight:700;display:flex;align-items:center;justify-content:center;gap:8px;box-shadow:0 4px 24px rgba(0,255,136,0.3);transition:.3s;position:relative;overflow:hidden}
.btn::before{content:'';position:absolute;inset:0;background:rgba(255,255,255,.1);opacity:0;transition:.3s}
.btn:hover::before{opacity:1}
.btn:hover{transform:translateY(-2px);box-shadow:0 8px 32px rgba(0,255,136,0.4)}
.btn:active{transform:translateY(0) scale(.98)}
.btn:disabled{opacity:.5;cursor:not-allowed;transform:none}
.footer{margin-top:24px;padding-top:18px;border-top:1px solid var(--card-b);display:flex;align-items:center;justify-content:center;gap:8px;font-size:11px;color:var(--t3)}
.footer a{color:var(--accent);font-weight:600;text-decoration:none;display:flex;align-items:center;gap:4px}
.footer a:hover{color:var(--accent2)}
</style>
</head>
<body>
<div class="blob blob-g"></div><div class="blob blob-b"></div>
<div class="wrap">
  <div class="card">
    <div class="brand">
...
*{margin:0;padding:0;box-sizing:border-box}
:root{
--bg:#0B0E17;--bg2:#111827;--bg3:#1F2937;
  --card:rgba(17,24,39,0.8);--card-b:rgba(0,255,136,0.12);--card-bh:rgba(0,255,136,0.3);
  --accent:#00FF88;--accent2:#00CC6A;--accent-d:rgba(0,255,136,0.1);
  --blue:#0066FF;--blue-bg:rgba(0,102,255,0.1);
  --green:#00FF88;--green-bg:rgba(0,255,136,0.1);
  --red:#FF4444;--red-bg:rgba(255,68,68,0.1);
  --amber:#FFB800;--amber-bg:rgba(255,184,0,0.1);
  --purple:#A855F7;--purple-bg:rgba(168,85,247,0.1);
  --t1:#F0F4F8;--t2:#9CA3AF;--t3:#6B7280;
...
[data-theme="light"]{
  ...
  --card:rgba(255,255,255,0.9);--card-b:rgba(0,204,106,0.15);--card-bh:rgba(0,204,106,0.3);
  --accent:#00CC6A;--accent2:#009950;--accent-d:rgba(0,204,106,0.08);
  --blue:#0052CC;--blue-bg:rgba(0,82,204,0.08);
  --green:#00AA55;--green-bg:rgba(0,170,85,0.08);--green-t:#008844;
  --red:#DD2222;--red-bg:rgba(221,34,34,0.08);--red-t:#BB1111;
  --amber:#CC9900;--amber-bg:rgba(204,153,0,0.08);--amber-t:#997300;
  --purple:#7C3AED;--purple-bg:rgba(124,58,237,0.08);--purple-t:#6D28D9;
...
.blob{position:fixed;border-radius:50%;filter:blur(120px);z-index:0;animation:blobFloat 12s ease-in-out infinite;pointer-events:none}
.blob-g{width:500px;height:500px;background:rgba(0,255,136,0.04);top:-150px;right:-120px}
.blob-b{width:400px;height:400px;background:rgba(0,102,255,0.03);bottom:-100px;left:-100px;animation-delay:6s}
...
.sidebar{width:var(--sidebar-w);min-height:100vh;background:rgba(17,24,39,0.7);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border-left:1px solid var(--card-b);display:flex;flex-direction:column;flex-shrink:0;position:fixed;right:0;top:0;bottom:0;z-index:200;transition:transform .3s cubic-bezier(.4,0,.2,1),background .3s,border-color .3s}
.logo{display:flex;align-items:center;gap:12px;padding:20px 16px 16px;border-bottom:1px solid var(--card-b)}
.logo-img{width:38px;height:38px;border-radius:50%;overflow:hidden;border:1.5px solid var(--card-bh);box-shadow:0 0 16px rgba(0,255,136,0.2),0 0 8px rgba(0,102,255,0.15);flex-shrink:0}
.logo-img img{width:100%;height:100%;object-fit:cover}
.logo-name{font-size:13.5px;font-weight:700;color:var(--t1)}
.logo-sub{font-size:10px;color:var(--accent);margin-top:1px;font-weight:600}
...
.nav-it{display:flex;align-items:center;gap:9px;padding:9px 14px;color:var(--t3);font-size:12.5px;cursor:pointer;border-right:3px solid transparent;transition:all .3s;margin:1px 6px;border-radius:0 10px 10px 0}
.nav-it i{font-size:16px;width:18px;text-align:center;flex-shrink:0}
.nav-it:hover{background:var(--accent-d);color:var(--t2)}
.nav-it.on{background:var(--accent-d);color:var(--t1);border-right-color:var(--accent);font-weight:600;box-shadow:0 0 15px rgba(0,255,136,0.05)}
.nav-badge{margin-right:auto;background:rgba(0,255,136,0.15);color:var(--accent);font-size:9px;padding:1px 6px;border-radius:20px;font-weight:700}
.sb-foot{padding:12px 14px;border-top:1px solid var(--card-b)}
.tg-btn{display:flex;align-items:center;justify-content:center;gap:8px;background:linear-gradient(135deg,var(--accent),#00CC6A);color:#0B0E17;border-radius:50px;padding:10px;font-size:12.5px;font-weight:700;font-family:inherit;border:none;cursor:pointer;width:100%;transition:.3s}
.tg-btn:hover{filter:brightness(1.1);transform:translateY(-1px);box-shadow:0 4px 16px rgba(0,255,136,0.3)}
.theme-btn{display:flex;align-items:center;justify-content:center;gap:7px;background:var(--accent-d);color:var(--t2);border-radius:50px;padding:8px;font-size:12px;font-weight:500;font-family:inherit;border:1px solid var(--card-b);cursor:pointer;width:100%;transition:.3s;margin-bottom:7px}
.theme-btn:hover{background:var(--card-b);color:var(--t1)}
.logout-btn{display:flex;align-items:center;justify-content:center;gap:7px;background:var(--red-bg);color:var(--red);border-radius:50px;padding:8px;font-size:12px;font-weight:500;font-family:inherit;border:1px solid rgba(255,68,68,0.15);cursor:pointer;width:100%;transition:.3s;margin-top:6px}
.logout-btn:hover{background:rgba(255,68,68,0.15);transform:translateY(-1px)}
.mob-top{display:none;position:fixed;top:0;right:0;left:0;height:52px;background:rgba(17,24,39,0.85);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border-bottom:1px solid var(--card-b);z-index:150;align-items:center;justify-content:space-between;padding:0 14px;transition:background .3s}
.mob-top .ml{display:flex;align-items:center;gap:9px}
.mob-logo{width:28px;height:28px;border-radius:50%;overflow:hidden;box-shadow:0 0 10px rgba(0,255,136,0.25)}
...
.menu-btn,.theme-mob{background:var(--accent-d);border:1px solid var(--card-b);color:var(--t2);width:34px;height:34px;border-radius:10px;font-size:17px;display:flex;align-items:center;justify-content:center;cursor:pointer;transition:.3s}
...
.badge{font-size:10px;padding:3px 10px;border-radius:50px;font-weight:700;display:inline-flex;align-items:center;gap:5px;white-space:nowrap}
...
.metric{background:var(--card);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:var(--radius);padding:17px 17px 14px;transition:.3s;position:relative;overflow:hidden;cursor:default}
.metric::after{content:'';position:absolute;top:0;right:0;width:3px;height:100%;background:var(--accent);opacity:0;transition:.3s}
.metric:hover{border-color:var(--card-bh);transform:translateY(-3px);box-shadow:0 8px 24px rgba(0,0,0,0.3),0 0 20px rgba(0,255,136,0.05)}
...
.card{background:var(--card);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:var(--radius);padding:18px 20px;transition:border-color .3s,background .3s,box-shadow .3s}
...
.sr{display:flex;align-items:center;justify-content:space-between;padding:9px 0;border-bottom:1px solid rgba(0,255,136,0.04);font-size:12px}
...
.tog{width:19px;height:34px;border-radius:19px;background:rgba(100,116,139,0.25);position:relative;cursor:pointer;transition:.3s;flex-shrink:0;border:none}
.tog::after{content:'';position:absolute;width:13px;height:13px;border-radius:50%;background:#fff;left:3px;bottom:3px;transition:.3s;box-shadow:0 1px 3px rgba(0,0,0,.3)}
...
.fi,.fs{padding:9px 12px;border-radius:10px;border:1px solid var(--card-b);background:rgba(0,0,0,.18);color:var(--t1);font-family:inherit;font-size:12px;outline:none;transition:.3s;min-width:100px}
[data-theme="light"] .fi,[data-theme="light"] .fs{background:rgba(0,0,0,.04)}
.fi::placeholder{color:var(--t3)}
.fi:focus,.fs:focus{border-color:var(--accent);background:rgba(0,0,0,.25);box-shadow:0 0 0 3px rgba(0,255,136,0.08)}
.fs option{background:var(--bg2)}
[data-theme="light"] .fs option{background:#fff}

.cl{background:var(--accent-d);border:1px solid rgba(0,255,136,0.12);border-radius:12px;padding:11px 13px;font-size:11px;color:var(--t2);display:flex;gap:9px;align-items:flex-start;line-height:1.8;margin-top:12px}
.cl i{font-size:15px;color:var(--accent);margin-top:1px;flex-shrink:0}
.cl.amber{background:var(--amber-bg);border-color:rgba(255,184,0,0.15);color:var(--amber)}
.cl.amber i{color:var(--amber)}

.btn{font-family:inherit;font-size:12px;font-weight:500;border-radius:50px;padding:8px 14px;cursor:pointer;display:inline-flex;align-items:center;gap:5px;border:none;transition:.3s;white-space:nowrap}
.btn i{font-size:13px}
.btn:disabled{opacity:.4;cursor:not-allowed}
.btn-p{background:linear-gradient(135deg,var(--accent),#00CC6A);color:#0B0E17;box-shadow:0 3px 16px rgba(0,255,136,0.3)}
.btn-p:hover{box-shadow:0 6px 24px rgba(0,255,136,0.4);transform:translateY(-1px)}
...
.btn-g{background:var(--accent-d);color:var(--accent);border:1px solid rgba(0,255,136,0.12)}
.btn-g:hover{background:rgba(0,255,136,0.15)}
.btn-d{background:var(--red-bg);color:var(--red);border:1px solid rgba(255,68,68,0.15)}
.btn-d:hover{background:rgba(255,68,68,0.15)}
...
.btn-amber{background:var(--amber-bg);color:var(--amber);border:1px solid rgba(255,184,0,0.15)}
.btn-amber:hover{background:rgba(255,184,0,0.15)}
.btn-sm{padding:5px 9px;font-size:10.5px;border-radius:50px}
.btn-icon{width:30px;height:30px;padding:0;justify-content:center;border-radius:50px}

/* Traffic hero */
.traf-hero{display:grid;grid-template-columns:1.4fr 1fr 1fr 1fr;gap:13px;margin-bottom:18px}
.traf-main-stat{background:linear-gradient(155deg,var(--bg3) 0%,var(--card) 60%);border:1px solid var(--card-b);border-radius:20px;padding:22px 24px;position:relative;overflow:hidden;backdrop-filter:blur(20px)}
.traf-main-stat::before{content:'';position:absolute;top:-50px;left:-50px;width:200px;height:200px;background:radial-gradient(circle,rgba(0,255,136,0.08),transparent 70%);pointer-events:none}
...
.traf-mini{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:20px;padding:18px 19px;display:flex;flex-direction:column;justify-content:space-between;transition:.3s}
...
.traf-mini-icon{width:32px;height:32px;border-radius:10px;background:var(--accent-d);color:var(--accent);display:flex;align-items:center;justify-content:center;font-size:15px}
...
.traf-chart-card{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:22px;padding:22px 24px 18px;box-shadow:var(--shadow);margin-bottom:16px}
...
.traf-range-tab.on{background:var(--accent);color:#0B0E17;box-shadow:0 2px 10px rgba(0,255,136,0.3)}
...
/* Config create panel */
.create-panel{background:linear-gradient(155deg,var(--bg3) 0%,var(--card) 55%);border:1px solid var(--card-b);border-radius:22px;padding:0;overflow:hidden;box-shadow:var(--shadow);margin-bottom:16px;position:relative;backdrop-filter:blur(20px)}
.create-panel::before{content:'';position:absolute;top:-60px;left:-60px;width:220px;height:220px;background:radial-gradient(circle,rgba(0,255,136,0.06),transparent 70%);pointer-events:none}
.cp-head{display:flex;align-items:center;gap:13px;padding:22px 24px 18px;position:relative;z-index:1}
.cp-head-icon{width:44px;height:44px;border-radius:14px;background:linear-gradient(135deg,var(--accent),#00CC6A);display:flex;align-items:center;justify-content:center;color:#0B0E17;font-size:20px;flex-shrink:0;box-shadow:0 6px 20px rgba(0,255,136,0.3)}
...
[data-theme="light"] .cp-block{background:rgba(0,204,106,0.03)}
...
.cp-input-full{width:100%;padding:10px 13px;border-radius:10px;border:1px solid var(--card-b);background:rgba(0,0,0,.18);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.3s}
[data-theme="light"] .cp-input-full{background:#fff}
.cp-input-full:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(0,255,136,0.08)}
...
.chip{font-size:10.5px;font-weight:700;padding:5px 12px;border-radius:50px;background:var(--accent-d);color:var(--t2);border:1px solid var(--card-b);cursor:pointer;transition:.3s;white-space:nowrap}
.chip:hover{background:rgba(0,255,136,0.12);color:var(--accent)}
.chip.active{background:var(--accent);color:#0B0E17;border-color:var(--accent);box-shadow:0 3px 12px rgba(0,255,136,0.3)}
.proto-cards{display:grid;grid-template-columns:repeat(3,1fr);gap:9px}
.proto-card{border:1.5px solid var(--card-b);border-radius:14px;padding:13px 12px;cursor:pointer;transition:.3s;text-align:center;position:relative;background:rgba(0,0,0,.1)}
[data-theme="light"] .proto-card{background:#fff}
.proto-card:hover{border-color:var(--card-bh);transform:translateY(-2px)}
.proto-card.active{border-color:var(--accent);background:var(--accent-d);box-shadow:0 0 0 3px rgba(0,255,136,0.08)}
.proto-card.active .proto-card-check{opacity:1;transform:scale(1)}
.proto-card-check{position:absolute;top:7px;left:7px;width:16px;height:16px;border-radius:50%;background:var(--accent);color:#0B0E17;font-size:10px;display:flex;align-items:center;justify-content:center;opacity:0;transform:scale(.5);transition:.3s}
...
.proto-card.active .proto-card-icon{background:var(--accent);color:#0B0E17}
...
.cp-submit-btn{background:linear-gradient(135deg,var(--accent),#00CC6A);color:#0B0E17;border:none;border-radius:50px;padding:13px 28px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 24px rgba(0,255,136,0.3);transition:.3s;white-space:nowrap}
.cp-submit-btn:hover{transform:translateY(-2px);box-shadow:0 10px 32px rgba(0,255,136,0.4)}
...
/* Server panel */
.srv-panel{background:linear-gradient(155deg,var(--bg3) 0%,var(--card) 60%);border:1px solid var(--card-b);border-radius:22px;overflow:hidden;box-shadow:var(--shadow);position:relative;backdrop-filter:blur(20px)}
.srv-panel::before{content:'';position:absolute;top:-60px;left:-60px;width:200px;height:200px;background:radial-gradient(circle,rgba(0,255,136,0.06),transparent 70%);pointer-events:none}
...
.srv-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,var(--accent),#00CC6A);display:flex;align-items:center;justify-content:center;color:#0B0E17;font-size:22px;flex-shrink:0;box-shadow:0 6px 20px rgba(0,255,136,0.3)}
...
.srv-tile{display:flex;align-items:center;gap:11px;background:rgba(0,0,0,.14);border:1px solid var(--card-b);border-radius:14px;padding:12px 14px;transition:.3s}
[data-theme="light"] .srv-tile{background:rgba(0,204,106,0.03)}
...
/* Password panel */
.pw-panel{background:linear-gradient(155deg,var(--bg3) 0%,var(--card) 60%);border:1px solid var(--card-b);border-radius:22px;overflow:hidden;box-shadow:var(--shadow);position:relative;backdrop-filter:blur(20px)}
...
.pw-input{width:100%;padding:11px 42px 11px 14px;border-radius:12px;border:1px solid var(--card-b);background:rgba(0,0,0,.18);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.3s}
...
.conn-hero-tile{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:16px;padding:16px 18px;position:relative;overflow:hidden;transition:.3s}
...
.conn-live-badge{display:flex;align-items:center;gap:6px;font-size:10.5px;font-weight:700;color:var(--green);background:var(--green-bg);padding:5px 12px;border-radius:50px;border:1px solid rgba(0,255,136,0.15)}
...
.conn-card-v2{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:18px;padding:0;overflow:hidden;transition:all .3s cubic-bezier(.4,0,.2,1);position:relative}
.conn-card-v2:hover{border-color:var(--card-bh);transform:translateY(-3px);box-shadow:0 14px 32px rgba(0,0,0,.22)}
.conn-card-v2-glow{position:absolute;top:-40px;left:-40px;width:140px;height:140px;background:radial-gradient(circle,rgba(0,255,136,0.06),transparent 70%);pointer-events:none}
.conn-card-v2-top{display:flex;align-items:center;gap:12px;padding:16px 17px 13px;position:relative;z-index:1}
.conn-avatar{width:42px;height:42px;border-radius:13px;background:linear-gradient(135deg,var(--green),#009955);display:flex;align-items:center;justify-content:center;color:#fff;font-size:18px;flex-shrink:0;position:relative;box-shadow:0 4px 14px rgba(0,255,136,0.25)}
...
.conn-duration-fill{height:100%;border-radius:4px;background:linear-gradient(90deg,var(--green),#34D399);position:relative;overflow:hidden}
...
.sub-box{background:rgba(168,85,247,.07);border:1px solid rgba(168,85,247,0.15);border-radius:12px;padding:14px 16px;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;margin-top:11px}
...
.subs-search input{width:100%;padding:11px 40px 11px 15px;border-radius:12px;border:1px solid var(--card-b);background:var(--card);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.3s}
.subs-search input:focus{border-color:var(--purple);box-shadow:0 0 0 3px rgba(168,85,247,0.08)}
...
.sub-card{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:20px;padding:0;overflow:hidden;transition:all .3s cubic-bezier(.4,0,.2,1);position:relative}
...
.sub-card-top::before{content:'';position:absolute;top:-30px;left:-30px;width:130px;height:130px;background:radial-gradient(circle,rgba(168,85,247,0.1),transparent 70%);pointer-events:none}
.sub-card-head-v2{display:flex;align-items:flex-start;gap:13px;position:relative;z-index:1}
.sub-card-icon{width:46px;height:46px;border-radius:14px;background:linear-gradient(135deg,var(--purple),#7C3AED);display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 16px rgba(168,85,247,0.3)}
...
.sub-card-lock-badge.locked{background:var(--amber-bg);color:var(--amber)}
.sub-card-lock-badge.open{background:var(--green-bg);color:var(--green)}
...
[data-theme="light"] .sub-card-stats{background:rgba(168,85,247,0.03)}
...
.sub-card-url-row{margin:14px 20px 0;background:rgba(168,85,247,.06);border:1px dashed rgba(168,85,247,0.2);border-radius:11px;padding:9px 12px;display:flex;align-items:center;gap:8px}
...
.sub-card-url-copy{background:none;border:none;color:var(--purple);cursor:pointer;font-size:13px;padding:3px;display:flex;flex-shrink:0;transition:.3s}
...
/* Modal v2 */
.modal-v2{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:22px;padding:0;max-width:430px;width:calc(100% - 32px);max-height:92vh;overflow-y:auto;position:relative;animation:fi .2s ease;box-shadow:0 24px 70px rgba(0,0,0,.5)}
.modal-v2-head{background:linear-gradient(155deg,rgba(168,85,247,.1) 0%,transparent 65%);padding:18px 22px 14px;position:relative;overflow:hidden}
.modal-v2-head::before{content:'';position:absolute;top:-50px;left:-50px;width:160px;height:160px;background:radial-gradient(circle,rgba(168,85,247,0.15),transparent 70%);pointer-events:none}
.modal-v2-close{position:absolute;top:14px;left:14px;background:var(--accent-d);border:1px solid var(--card-b);color:var(--t2);width:30px;height:30px;border-radius:9px;font-size:15px;display:flex;align-items:center;justify-content:center;cursor:pointer;z-index:2;transition:.3s}
.modal-v2-close:hover{background:var(--red-bg);color:var(--red);border-color:rgba(255,68,68,0.2)}
.modal-v2-icon{width:42px;height:42px;border-radius:13px;background:linear-gradient(135deg,var(--purple),#7C3AED);display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;margin-bottom:10px;position:relative;z-index:1;box-shadow:0 8px 18px rgba(168,85,247,0.35)}
...
.modal-v2-input-wrap>i{position:absolute;right:13px;top:50%;transform:translateY(-50%);color:var(--t3);font-size:14px;pointer-events:none;transition:.3s;z-index:1}
.modal-v2-input{width:100%;padding:9px 38px 9px 13px;border-radius:11px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.3s}
[data-theme="light"] .modal-v2-input{background:rgba(168,85,247,0.04)}
.modal-v2-input::placeholder{color:var(--t3)}
.modal-v2-input:focus{border-color:var(--purple);box-shadow:0 0 0 3px rgba(168,85,247,0.08);background:rgba(0,0,0,.28)}
[data-theme="light"] .modal-v2-input:focus{background:#fff}
.modal-v2-input:focus~i{color:var(--purple)}
.modal-v2-hint{background:rgba(0,255,136,.06);border:1px solid rgba(0,255,136,0.12);border-radius:11px;padding:9px 12px;font-size:10px;color:var(--t2);display:flex;gap:7px;align-items:flex-start;line-height:1.6;margin-top:2px}
...
.modal-v2-btn-cancel{flex:.75;justify-content:center;padding:10px;border-radius:50px;background:transparent;border:1px solid var(--card-b);color:var(--t2);font-family:inherit;font-size:12px;font-weight:700;cursor:pointer;transition:.3s;display:flex;align-items:center}
.modal-v2-btn-cancel:hover{background:var(--accent-d);color:var(--t1)}
.modal-v2-btn-submit{flex:1;justify-content:center;padding:10px;border-radius:50px;background:linear-gradient(135deg,var(--purple),#7C3AED);color:#fff;border:none;font-family:inherit;font-size:12px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;box-shadow:0 6px 18px rgba(168,85,247,0.35);transition:.3s}
.modal-v2-btn-submit:hover{transform:translateY(-2px);box-shadow:0 10px 24px rgba(168,85,247,0.45)}
.modal-v2-btn-submit:active{transform:translateY(0) scale(.98)}

/* Link modal */
.lmodal-head{background:linear-gradient(155deg,rgba(0,255,136,.06) 0%,transparent 70%);padding:22px 24px 18px;position:relative;border-bottom:1px solid var(--card-b)}
.lmodal-icon-row{display:flex;align-items:center;gap:12px;position:relative;z-index:1}
.lmodal-icon{width:44px;height:44px;border-radius:14px;background:linear-gradient(135deg,var(--accent),#00CC6A);display:flex;align-items:center;justify-content:center;color:#0B0E17;font-size:19px;flex-shrink:0;box-shadow:0 6px 16px rgba(0,255,136,0.3)}
...
.lmodal-search input:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(0,255,136,0.08)}
...
.lmodal-qbtn{font-size:10px;font-weight:700;padding:5px 11px;border-radius:50px;background:var(--accent-d);color:var(--accent);border:1px solid var(--card-b);cursor:pointer;transition:.3s;font-family:inherit}
.lmodal-qbtn:hover{background:rgba(0,255,136,0.12)}
...
.lrow-v2{display:flex;align-items:center;gap:11px;padding:11px 12px;border-radius:13px;cursor:pointer;transition:.3s;margin-bottom:4px;border:1px solid transparent}
.lrow-v2:hover{background:var(--accent-d)}
.lrow-v2.checked{background:rgba(0,255,136,.06);border-color:rgba(0,255,136,0.15)}
.lrow-v2-check{width:20px;height:20px;border-radius:7px;border:2px solid var(--card-b);flex-shrink:0;display:flex;align-items:center;justify-content:center;transition:.3s;background:rgba(0,0,0,.14)}
.lrow-v2.checked .lrow-v2-check{background:var(--accent);border-color:var(--accent)}
.lrow-v2-check i{font-size:12px;color:#fff;opacity:0;transform:scale(.5);transition:.3s}
...
.lrow-v2-status{font-size:9px;font-weight:800;padding:3px 9px;border-radius:50px;flex-shrink:0;white-space:nowrap}
.lrow-v2-status.on{background:var(--green-bg);color:var(--green)}
.lrow-v2-status.off{background:var(--red-bg);color:var(--red)}
...
.modal-bg{display:none;position:fixed;inset:0;background:rgba(0,0,0,.6);z-index:500;align-items:center;justify-content:center;backdrop-filter:blur(6px)}
.modal-bg.open{display:flex}
.modal{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:22px;padding:28px 26px;max-width:520px;width:calc(100% - 32px);max-height:90vh;overflow-y:auto;position:relative;animation:fi .2s ease}
.modal-close{position:absolute;top:14px;left:14px;background:var(--accent-d);border:1px solid var(--card-b);color:var(--t2);width:30px;height:30px;border-radius:9px;font-size:16px;display:flex;align-items:center;justify-content:center;cursor:pointer;border:none}
...
.lrow{display:flex;align-items:center;gap:8px;padding:7px 0;border-bottom:1px solid rgba(0,255,136,.04)}
...
.lrow-badge{font-size:9px;padding:2px 7px;border-radius:5px;background:var(--green-bg);color:var(--green);font-weight:700}
...
.toast.ok{border-color:rgba(0,255,136,.3);background:var(--green-bg);color:var(--green)}
.toast.err{border-color:rgba(255,68,68,.3);background:var(--red-bg);color:var(--red)}
...
.cfg-card{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:14px;padding:0;transition:all .3s cubic-bezier(.4,0,.2,1);position:relative;overflow:hidden}
...
.cfg-uuid-mini:hover{background:rgba(0,255,136,0.15)}
...
.ubar{height:5px;border-radius:4px;background:rgba(0,255,136,0.08);overflow:hidden}
...
.bulk-bar{display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap;background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:14px;padding:10px 16px;margin-bottom:12px}
...
.cfgdash-item{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:14px;padding:13px 14px;cursor:pointer;transition:.3s}
...
.conn-card{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:16px;padding:15px 17px;transition:.3s;position:relative;overflow:hidden}
...
.conn-ip-icon{width:32px;height:32px;border-radius:9px;background:var(--green-bg);color:var(--green);display:flex;align-items:center;justify-content:center;font-size:15px;flex-shrink:0}
...
.log-item{display:flex;gap:12px;padding:11px 0;border-bottom:1px solid rgba(0,255,136,.04);position:relative}
...
.erow{padding:9px 0;border-bottom:1px solid rgba(0,255,136,.04)}
...
def get_public_page_html(uuid_key: str) -> str:
    """صفحه پابلیکساب v3 — Modern Dark Neon design"""
...
.bg-fx{{position:fixed;inset:0;background:var(--bg);z-index:0;pointer-events:none;transition:background .35s}}
.blob{{position:fixed;border-radius:50%;filter:blur(120px);z-index:0;animation:blobFloat 12s ease-in-out infinite;pointer-events:none}}
.blob-g{{width:500px;height:500px;background:rgba(0,255,136,0.06);top:-150px;right:-120px}}
.blob-b{{width:400px;height:400px;background:rgba(0,102,255,0.04);bottom:-100px;left:-100px;animation-delay:6s}}
@keyframes blobFloat{{0%,100%{{transform:translate(0,0) scale(1)}}33%{{transform:translate(30px,-20px) scale(1.05)}}66%{{transform:translate(-20px,30px) scale(0.95)}}}}
@keyframes spin{{to{{transform:rotate(360deg)}}}}
@keyframes pulse{{0%,100%{{opacity:1}}50%{{opacity:.25}}}}
@keyframes breathe{{0%,100%{{transform:scale(1);opacity:.5}}50%{{transform:scale(1.08);opacity:0}}}}
...
.brand-img{{width:40px;height:40px;border-radius:50%;overflow:hidden;border:1.5px solid var(--card-bh);box-shadow:0 0 16px rgba(0,255,136,0.2),0 0 8px rgba(0,102,255,0.15);flex-shrink:0}}
.brand-img img{{width:100%;height:100%;object-fit:cover}}
...
.icon-btn{{width:36px;height:36px;border-radius:50px;background:var(--card);border:1px solid var(--card-b);color:var(--t2);display:flex;align-items:center;justify-content:center;font-size:16px;cursor:pointer;transition:.3s;backdrop-filter:blur(20px)}}
.icon-btn:hover{{background:var(--accent-d);color:var(--accent);border-color:var(--card-bh)}}
.sub-info{{background:var(--card);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:22px;padding:24px 24px 22px;margin-bottom:16px;box-shadow:var(--shadow);position:relative;overflow:hidden}}
.sub-info::before{{content:'';position:absolute;top:0;right:0;width:160px;height:160px;background:radial-gradient(circle at top right,rgba(0,255,136,.06),transparent 70%);pointer-events:none}}
.sub-eyebrow{{font-size:10px;font-weight:700;color:var(--accent);text-transform:uppercase;letter-spacing:.12em;margin-bottom:8px;display:flex;align-items:center;gap:6px}}
...
.stat-card{{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:16px;padding:16px 17px;transition:.3s}}
...
.copy-all-bar{{display:flex;align-items:center;gap:12px;background:linear-gradient(120deg,var(--accent) 0%,var(--accent2) 100%);border-radius:18px;padding:16px 19px;margin-bottom:18px;box-shadow:0 10px 30px rgba(0,255,136,.2);flex-wrap:wrap}}
.copy-all-text{{flex:1;min-width:160px}}
.copy-all-title{{font-size:13.5px;font-weight:800;color:#0B0E17;display:flex;align-items:center;gap:6px}}
.copy-all-sub{{font-size:10px;color:rgba(11,14,23,.7);margin-top:3px}}
.copy-all-btn{{background:#0B0E17;color:var(--accent);border:none;border-radius:50px;padding:10px 19px;font-family:inherit;font-size:12.5px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;transition:.3s;white-space:nowrap}}
...
.cfg-card{{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:18px;transition:all .3s;position:relative;overflow:hidden}}
...
.pc-xhttp{{background:var(--purple-bg);color:var(--purple)}}
.pc-ultra{{background:var(--green-bg);color:var(--green)}}
.cfg-status{{display:flex;align-items:center;gap:5px;font-size:10px;font-weight:700;padding:4px 10px;border-radius:50px;white-space:nowrap}}
.cfg-status.ok{{background:var(--green-bg);color:var(--green)}}
.cfg-status.no{{background:var(--red-bg);color:var(--red)}}
.ubar{{height:6px;border-radius:4px;background:rgba(0,255,136,0.08);overflow:hidden;margin-bottom:5px}}
...
.cfg-link-toggle{{width:100%;display:flex;align-items:center;justify-content:space-between;gap:10px;background:transparent;border:1px dashed var(--card-b);border-radius:11px;padding:10px 13px;cursor:pointer;font-family:inherit;color:var(--t2);font-size:11.5px;font-weight:600;transition:.3s}}
...
.cfg-link-toggle i.ti-chevron-down{{transition:transform .3s}}
...
[data-theme="light"] .cfg-vless{{background:rgba(0,204,106,.05)}}
.cfg-actions{{display:flex;gap:7px;flex-wrap:wrap;margin-top:11px}}
.btn{{font-family:inherit;font-size:11.5px;font-weight:700;border-radius:50px;padding:8px 15px;cursor:pointer;display:inline-flex;align-items:center;gap:5px;border:none;transition:.3s;white-space:nowrap}}
.btn i{{font-size:13px}}
.btn-p{{background:linear-gradient(135deg,var(--accent),#00CC6A);color:#0B0E17;box-shadow:0 3px 16px rgba(0,255,136,.3)}}
.btn-p:hover{{box-shadow:0 6px 24px rgba(0,255,136,.4)}}
.btn-g{{background:var(--accent-d);color:var(--accent);border:1px solid rgba(0,255,136,.12)}}
.btn-g:hover{{background:rgba(0,255,136,.12)}}
.btn-pur{{background:var(--purple-bg);color:var(--purple);border:1px solid rgba(168,85,247,.15)}}
.btn-pur:hover{{background:rgba(168,85,247,.15)}}
.conn-chip{{display:inline-flex;align-items:center;gap:4px;font-size:9.5px;padding:3px 8px;border-radius:50px;background:var(--green-bg);color:var(--green);font-weight:700}}
...
.lock-card{{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:26px;padding:0;text-align:center;max-width:380px;width:100%;box-shadow:var(--shadow);overflow:hidden;position:relative}}
.lock-banner{{background:linear-gradient(150deg,rgba(0,255,136,.06),rgba(0,102,255,.03) 70%);padding:38px 30px 26px;position:relative}}
...
.lock-shield i{{font-size:28px;color:var(--accent)}}
...
.lock-inp{{width:100%;padding:13px 44px 13px 44px;border-radius:13px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:14px;outline:none;text-align:center;letter-spacing:.14em;transition:.3s}}
[data-theme="light"] .lock-inp{{background:rgba(0,204,106,.04)}}
...
.lock-err{{color:var(--red);font-size:11.5px;margin-bottom:10px;min-height:16px;display:flex;align-items:center;justify-content:center;gap:5px}}
.lock-btn{{width:100%;justify-content:center;padding:13px;font-size:13px;border-radius:50px}}
...
.qr-box{{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:22px;padding:26px;text-align:center;max-width:340px;width:100%;box-shadow:var(--shadow)}}
