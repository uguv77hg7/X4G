...
:root{--bg:#060A14;--bg2:#0C1222;--card:rgba(12,18,34,0.75);--card-b:rgba(99,102,241,0.2);--card-bh:rgba(99,102,241,0.5);--accent:#818CF8;--accent2:#6366F1;--accent3:#A78BFA;--cyan:#22D3EE;--green:#34D399;--red:#F87171;--red-bg:rgba(248,113,113,0.08);--t1:#F1F5F9;--t2:#94A3B8;--t3:#64748B}
[data-theme="light"]{--bg:#F0F2F8;--bg2:#E8ECF4;--card:rgba(255,255,255,0.9);--card-b:rgba(99,102,241,0.15);--card-bh:rgba(99,102,241,0.35);--accent:#6366F1;--accent2:#4F46E5;--accent3:#8B5CF6;--t1:#0F172A;--t2:#475569;--t3:#94A3B8}
...
.aurora::before{width:600px;height:600px;background:radial-gradient(circle,rgba(99,102,241,0.12),transparent 70%);top:-200px;right:-150px}
.aurora::after{width:500px;height:500px;background:radial-gradient(circle,rgba(34,211,238,0.08),transparent 70%);bottom:-200px;left:-150px;animation-delay:-10s}
...
.star{position:absolute;width:2px;height:2px;background:#fff;border-radius:50%;animation:twinkle var(--d,3s) ease-in-out infinite var(--dl,0s);opacity:0}
...
.card{position:relative;background:var(--card);backdrop-filter:blur(40px) saturate(1.5);-webkit-backdrop-filter:blur(40px) saturate(1.5);border:1px solid var(--card-b);border-radius:28px;padding:44px 36px 36px;overflow:hidden;transition:all .4s cubic-bezier(.4,0,.2,1)}
.card::before{content:'';position:absolute;top:-1px;left:20%;right:20%;height:1px;background:linear-gradient(90deg,transparent,var(--accent),transparent);opacity:0;transition:opacity .4s}
.card:hover::before{opacity:1}
.card::after{content:'';position:absolute;inset:-1px;border-radius:28px;padding:1px;background:linear-gradient(135deg,rgba(99,102,241,0.3),transparent 40%,transparent 60%,rgba(34,211,238,0.2));-webkit-mask:linear-gradient(#fff 0 0) content-box,linear-gradient(#fff 0 0);mask:linear-gradient(#fff 0 0) content-box,linear-gradient(#fff 0 0);-webkit-mask-composite:xor;mask-composite:exclude;pointer-events:none;opacity:0;transition:opacity .4s}
.card:hover::after{opacity:1}
.glow-tl{position:absolute;top:-60px;left:-60px;width:180px;height:180px;background:radial-gradient(circle,rgba(99,102,241,0.15),transparent 70%);border-radius:50%;filter:blur(40px);animation:pulse 4s ease-in-out infinite;pointer-events:none}
.glow-br{position:absolute;bottom:-60px;right:-60px;width:160px;height:160px;background:radial-gradient(circle,rgba(34,211,238,0.1),transparent 70%);border-radius:50%;filter:blur(40px);animation:pulse 4s ease-in-out infinite 2s;pointer-events:none}
...
.logo-ring{width:88px;height:88px;border-radius:50%;padding:3px;background:conic-gradient(from 0deg,var(--accent),var(--cyan),var(--accent3),var(--accent));animation:logoSpin 8s linear infinite;position:relative}
...
.logo-pulse{position:absolute;inset:-8px;border-radius:50%;border:1px solid rgba(99,102,241,0.2);animation:logoPulse 2s ease-in-out infinite}
...
.logo-title{font-size:28px;font-weight:900;background:linear-gradient(135deg,var(--accent),var(--cyan),var(--accent3));-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;letter-spacing:-.03em;line-height:1.2}
...
.hint{display:flex;align-items:center;gap:10px;background:rgba(99,102,241,0.06);border:1px solid rgba(99,102,241,0.12);border-radius:14px;padding:11px 14px;margin-bottom:24px;transition:all .3s}
.hint:hover{background:rgba(99,102,241,0.1);border-color:rgba(99,102,241,0.2)}
.hint-label{font-size:11px;color:var(--t3);flex:1}
.hint-val{font-family:'SF Mono',ui-monospace,monospace;font-size:13px;font-weight:700;color:var(--accent);background:rgba(99,102,241,0.08);border:1px solid rgba(99,102,241,0.15);padding:4px 12px;border-radius:8px;cursor:pointer;transition:all .2s;letter-spacing:.06em}
.hint-val:hover{background:rgba(99,102,241,0.15);transform:scale(1.05)}
...
.inp-wrap input{width:100%;padding:15px 48px 15px 18px;border-radius:14px;border:1.5px solid rgba(99,102,241,0.12);background:rgba(6,10,20,0.6);color:var(--t1);font-family:inherit;font-size:14px;outline:none;transition:all .3s;backdrop-filter:blur(10px)}
.inp-wrap input:focus{border-color:var(--accent);background:rgba(6,10,20,0.8);box-shadow:0 0 0 4px rgba(99,102,241,0.08),0 0 30px rgba(99,102,241,0.05)}
...
.inp-wrap input:focus~.ic{color:var(--accent);filter:drop-shadow(0 0 6px rgba(99,102,241,0.4))}
.inp-line{position:absolute;bottom:0;left:50%;width:0;height:2px;background:linear-gradient(90deg,var(--accent),var(--cyan));border-radius:1px;transition:all .3s;transform:translateX(-50%)}
...
.btn{width:100%;padding:15px;border-radius:14px;border:none;cursor:pointer;background:linear-gradient(135deg,var(--accent2),var(--accent),var(--accent3));color:#fff;font-family:inherit;font-size:15px;font-weight:700;display:flex;align-items:center;justify-content:center;gap:10px;position:relative;overflow:hidden;transition:all .3s;box-shadow:0 4px 24px rgba(99,102,241,0.25)}
...
.btn:hover{transform:translateY(-2px);box-shadow:0 8px 32px rgba(99,102,241,0.35)}
...
.footer{margin-top:28px;padding-top:20px;border-top:1px solid rgba(99,102,241,0.08);display:flex;align-items:center;justify-content:center;gap:8px;font-size:11px;color:var(--t3)}
...
.theme-btn{position:fixed;top:20px;left:20px;z-index:20;width:40px;height:40px;border-radius:12px;border:1px solid var(--card-b);background:var(--card);backdrop-filter:blur(20px);color:var(--t2);cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:18px;transition:all .3s}
...
<div class="ring" style="width:60px;height:60px;border-color:rgba(99,102,241,0.15);left:10%;--dl:0s;--o:0.12"></div>
<div class="ring" style="width:40px;height:40px;border-color:rgba(34,211,238,0.12);left:70%;--dl:4s;--o:0.1"></div>
<div class="ring" style="width:80px;height:80px;border-color:rgba(167,139,250,0.1);left:40%;--dl:8s;--o:0.08"></div>
<div class="ring" style="width:30px;height:30px;border-color:rgba(99,102,241,0.1);left:85%;--dl:12s;--o:0.1"></div>
...
--sidebar:rgba(15,20,35,0.85);
--card:rgba(20,27,45,0.6);--card-b:rgba(99,102,241,0.15);--card-bh:rgba(99,102,241,0.35);
--accent:#6366F1;--accent2:#818CF8;--accent-d:rgba(99,102,241,0.1);
...
--card:rgba(255,255,255,0.92);--card-b:rgba(99,102,241,0.12);--card-bh:rgba(99,102,241,0.25);
--accent:#4F46E5;--accent2:#6366F1;--accent-d:rgba(79,70,229,0.08);
...
.blob-1{width:600px;height:600px;background:rgba(99,102,241,0.06);top:-200px;right:-150px}
...
@keyframes glowPulse{0%,100%{box-shadow:0 0 20px rgba(99,102,241,0.1)}50%{box-shadow:0 0 40px rgba(99,102,241,0.2)}}
...
.logo-img{width:44px;height:44px;border-radius:14px;overflow:hidden;border:1.5px solid var(--accent);box-shadow:0 0 20px rgba(99,102,241,0.25),0 0 40px rgba(99,102,241,0.1);flex-shrink:0}
...
.sb-close{display:none;position:absolute;left:12px;top:24px;background:var(--accent-d);border:1px solid var(--card-b);color:var(--t2);width:32px;height:32px;border-radius:10px;font-size:16px;align-items:center;justify-content:center;cursor:pointer;transition:.3s}
...
.nav-it.on{background:var(--accent);color:#fff;border-right-color:var(--accent);font-weight:700;box-shadow:0 4px 20px rgba(99,102,241,0.3)}
.nav-badge{margin-right:auto;background:rgba(99,102,241,0.2);color:var(--accent2);font-size:9px;padding:2px 8px;border-radius:20px;font-weight:700}
...
.theme-btn{display:flex;align-items:center;justify-content:center;gap:8px;background:var(--accent-d);color:var(--t2);border-radius:50px;padding:9px;font-size:12px;font-weight:600;font-family:inherit;border:1px solid var(--card-b);cursor:pointer;width:100%;transition:.3s}
...
.mob-logo{width:32px;height:32px;border-radius:10px;overflow:hidden;box-shadow:0 0 12px rgba(99,102,241,0.3)}
...
.menu-btn,.theme-mob{background:var(--accent-d);border:1px solid var(--card-b);color:var(--t2);width:36px;height:36px;border-radius:12px;font-size:18px;display:flex;align-items:center;justify-content:center;cursor:pointer;transition:.3s}
...
.metric{background:var(--card);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:var(--radius);padding:20px;transition:.3s;position:relative;overflow:hidden;cursor:default}
.metric::before{content:'';position:absolute;top:0;left:0;right:0;height:3px;background:linear-gradient(90deg,var(--accent),var(--cyan));opacity:0;transition:.3s}
.metric:hover{border-color:var(--card-bh);transform:translateY(-4px);box-shadow:0 12px 32px rgba(0,0,0,0.3),0 0 20px rgba(99,102,241,0.08)}
...
.metric:hover .m-icon{background:var(--accent);color:#fff;box-shadow:0 4px 16px rgba(99,102,241,0.3)}
...
/* ─── CARDS ─── */
.card{background:var(--card);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:var(--radius);padding:20px 22px;transition:border-color .3s,background .3s,box-shadow .3s}
...
.sr{display:flex;align-items:center;justify-content:space-between;padding:10px 0;border-bottom:1px solid rgba(99,102,241,0.06);font-size:12px}
...
.tog::after{content:'';position:absolute;width:14px;height:14px;border-radius:50%;background:#fff;left:3px;bottom:3px;transition:.3s;box-shadow:0 1px 4px rgba(0,0,0,.3)}
...
.fi,.fs{padding:10px 13px;border-radius:10px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:12px;outline:none;transition:.3s;min-width:100px}
[data-theme="light"] .fi,[data-theme="light"] .fs{background:rgba(0,0,0,.03)}
.fi::placeholder{color:var(--t3)}
.fi:focus,.fs:focus{border-color:var(--accent);background:rgba(0,0,0,.28);box-shadow:0 0 0 3px rgba(99,102,241,0.1)}
.fs option{background:var(--bg2)}
[data-theme="light"] .fs option{background:#fff}

/* ─── CL (callout) ─── */
.cl{background:var(--accent-d);border:1px solid rgba(99,102,241,0.12);border-radius:12px;padding:11px 13px;font-size:11px;color:var(--t2);display:flex;gap:9px;align-items:flex-start;line-height:1.8;margin-top:12px}
...
.btn-p{background:linear-gradient(135deg,var(--accent),var(--accent2));color:#fff;box-shadow:0 4px 18px rgba(99,102,241,0.35)}
.btn-p:hover{box-shadow:0 8px 28px rgba(99,102,241,0.45);transform:translateY(-1px)}
...
.btn-g{background:var(--accent-d);color:var(--accent);border:1px solid rgba(99,102,241,0.12)}
...
.traf-main-stat{background:linear-gradient(155deg,var(--bg3) 0%,var(--card) 60%);border:1px solid var(--card-b);border-radius:20px;padding:24px;position:relative;overflow:hidden;backdrop-filter:blur(20px)}
.traf-main-stat::before{content:'';position:absolute;top:-50px;left:-50px;width:200px;height:200px;background:radial-gradient(circle,rgba(99,102,241,0.08),transparent 70%);pointer-events:none}
...
.traf-mini{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:20px;padding:20px;display:flex;flex-direction:column;justify-content:space-between;transition:.3s}
...
.traf-chart-card{background:var(--card);backdrop-filter:blur(20px);border:1px solid var(--card-b);border-radius:22px;padding:24px 26px 20px;box-shadow:var(--shadow);margin-bottom:16px}
...
.traf-range-tab.on{background:var(--accent);color:#fff;box-shadow:0 2px 10px rgba(99,102,241,0.3)}
...
.create-panel::before{content:'';position:absolute;top:-60px;left:-60px;width:220px;height:220px;background:radial-gradient(circle,rgba(99,102,241,0.06),transparent 70%);pointer-events:none}
.cp-head{display:flex;align-items:center;gap:13px;padding:22px 24px 18px;position:relative;z-index:1}
.cp-head-icon{width:44px;height:44px;border-radius:14px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 20px rgba(99,102,241,0.3)}
...
.cp-block{background:rgba(0,0,0,.15);border:1px solid var(--card-b);border-radius:14px;padding:14px 16px}
[data-theme="light"] .cp-block{background:rgba(99,102,241,0.03)}
...
.cp-input-full{width:100%;padding:10px 13px;border-radius:10px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.3s}
[data-theme="light"] .cp-input-full{background:#fff}
.cp-input-full:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(99,102,241,0.1)}
...
.chip:hover{background:rgba(99,102,241,0.18);color:var(--accent)}
.chip.active{background:var(--accent);color:#fff;border-color:var(--accent);box-shadow:0 3px 12px rgba(99,102,241,0.3)}
...
.proto-card.active{border-color:var(--accent);background:var(--accent-d);box-shadow:0 0 0 3px rgba(99,102,241,0.1)}
...
.cp-submit-btn{background:linear-gradient(135deg,var(--accent),var(--accent2));color:#fff;border:none;border-radius:50px;padding:13px 28px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 24px rgba(99,102,241,0.3);transition:.3s;white-space:nowrap}
.cp-submit-btn:hover{transform:translateY(-2px);box-shadow:0 10px 32px rgba(99,102,241,0.4)}
...
.srv-panel::before{content:'';position:absolute;top:-60px;left:-60px;width:200px;height:200px;background:radial-gradient(circle,rgba(99,102,241,0.06),transparent 70%);pointer-events:none}
...
.srv-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 20px rgba(99,102,241,0.3)}
...
.srv-tile{display:flex;align-items:center;gap:11px;background:rgba(0,0,0,.15);border:1px solid var(--card-b);border-radius:14px;padding:12px 14px;transition:.3s}
[data-theme="light"] .srv-tile{background:rgba(99,102,241,0.03)}
...
.pw-input{width:100%;padding:11px 42px 11px 14px;border-radius:12px;border:1px solid var(--card-b);background:rgba(0,0,0,.2);color:var(--t1);font-family:inherit;font-size:12.5px;outline:none;transition:.3s}
...
.conn-card-v2-glow{position:absolute;top:-40px;left:-40px;width:140px;height:140px;background:radial-gradient(circle,rgba(99,102,241,0.06),transparent 70%);pointer-events:none}
.conn-card-v2-top{display:flex;align-items:center;gap:12px;padding:16px 17px 13px;position:relative;z-index:1}
.conn-avatar{width:42px;height:42px;border-radius:13px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:18px;flex-shrink:0;position:relative;box-shadow:0 4px 14px rgba(99,102,241,0.25)}
...
.subs-search input:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(99,102,241,0.08)}
...
.ubar{height:5px;border-radius:4px;background:rgba(99,102,241,0.08);overflow:hidden}
...
.log-item{display:flex;gap:12px;padding:11px 0;border-bottom:1px solid rgba(99,102,241,0.06);position:relative}
...
.erow{padding:9px 0;border-bottom:1px solid rgba(99,102,241,0.06)}
...
.modal{background:var(--card);backdrop-filter:blur(24px);border:1px solid var(--card-b);border-radius:22px;padding:28px 26px;max-width:520px;width:calc(100% - 32px);max-height:90vh;overflow-y:auto;position:relative;animation:slideIn .25s ease}
.modal-close{position:absolute;top:14px;left:14px;background:var(--accent-d);border:1px solid var(--card-b);color:var(--t2);width:30px;height:30px;border-radius:9px;font-size:16px;display:flex;align-items:center;justify-content:center;cursor:pointer;border:none;transition:.3s}
