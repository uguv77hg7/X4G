...
:root{{
  ...
  --glass:rgba(10,15,30,0.7);--glass-b:rgba(0,229,160,0.15);
  --mint:#00E5A0;--mint2:#00CC8E;--mint-d:rgba(0,229,160,0.08);
...
.nebula .orb-2{{width:400px;height:400px;background:rgba(0,229,160,0.06);bottom:-120px;left:-80px;animation:nebDrift 22s ease-in-out infinite alternate-reverse}}
...
.hero-logo{{width:68px;height:68px;border-radius:22px;margin:0 auto 14px;overflow:hidden;border:2px solid var(--glass-b);box-shadow:0 0 50px rgba(0,229,160,0.18),0 0 100px rgba(124,58,237,0.08);animation:heroGlow 3.5s ease-in-out infinite}}
@keyframes heroGlow{{0%,100%{{box-shadow:0 0 50px rgba(0,229,160,0.18),0 0 100px rgba(124,58,237,0.08)}}50%{{box-shadow:0 0 70px rgba(0,229,160,0.28),0 0 130px rgba(124,58,237,0.14)}}}}
...
.sub-card::before{{content:'';position:absolute;top:0;right:0;width:180px;height:180px;background:radial-gradient(circle,rgba(0,229,160,0.08),transparent 70%);pointer-events:none}}
...
.stat-icon{{font-size:20px;margin-bottom:8px;color:var(--mint);filter:drop-shadow(0 0 8px rgba(0,229,160,0.3))}}
...
@keyframes cardBreathe{{0%,100%{{box-shadow:0 0 20px rgba(0,229,160,0.03)}}50%{{box-shadow:0 0 35px rgba(0,229,160,0.08)}}}}
.cfg-card:hover{{border-color:var(--mint);transform:translateY(-3px);box-shadow:0 20px 50px rgba(0,0,0,0.3),0 0 30px rgba(0,229,160,0.08)}}
...
.cfg-status-pill.ok{{background:rgba(0,229,160,0.15);color:var(--mint);border:1px solid rgba(0,229,160,0.2)}}
...
.usage-donut .ring-bg{{stroke:rgba(0,229,160,0.08)}}
...
/* Action strip (horizontal scrollable) */
...
.btn i{{font-size:13px}}
.btn-mint{{background:linear-gradient(135deg,var(--mint),var(--mint2));color:#05080F;box-shadow:0 3px 14px rgba(0,229,160,0.3)}}
.btn-mint:hover{{box-shadow:0 6px 24px rgba(0,229,160,0.45);transform:translateY(-1px)}}
...
[data-theme="light"] .cfg-vless{{background:rgba(0,229,160,0.04)}}

/* ═══ FAB ═══ */
.fab{{position:fixed;bottom:24px;left:24px;width:56px;height:56px;border-radius:50%;background:linear-gradient(135deg,var(--mint),var(--purple));border:none;color:#fff;font-size:22px;cursor:pointer;z-index:100;display:flex;align-items:center;justify-content:center;box-shadow:0 6px 28px rgba(0,229,160,0.35);transition:all .3s cubic-bezier(.22,1,.36,1)}}
.fab:hover{{transform:scale(1.1);box-shadow:0 8px 40px rgba(0,229,160,0.5)}}
...
.lock-banner{{background:linear-gradient(150deg,rgba(0,229,160,0.08),rgba(124,58,237,0.05) 70%);padding:36px 28px 24px;position:relative}}
...
[data-theme="light"] .lock-inp{{background:rgba(0,229,160,0.03)}}
...
.toast.show{{opacity:1;transform:translateX(-50%) translateY(0)}}
.toast.ok{{border-color:rgba(0,229,160,0.3);background:var(--mint-d);color:var(--mint)}}
...
@media(max-width:520px){{
  ...
  .cfg-card-body{{padding:16px}}
  .fab{{bottom:20px;left:20px;width:52px;height:52px;font-size:20px}}
}}
