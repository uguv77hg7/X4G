...
:root{--bg:#0a0a0f;--card:rgba(20,20,31,0.9);--accent:#D4AF37;--text:#F5F0E0;--dim:#706840;--mid:#B0A880;--border:rgba(212,175,55,0.2)}
...
.bg{position:fixed;inset:0;background:radial-gradient(ellipse 80% 60% at 50% 0%,rgba(212,175,55,0.08),transparent 70%),var(--bg);z-index:0}
.grid{position:fixed;inset:0;background-image:linear-gradient(rgba(212,175,55,0.04) 1px,transparent 1px),linear-gradient(90deg,rgba(212,175,55,0.04) 1px,transparent 1px);background-size:44px 44px;z-index:0}
.orb{position:fixed;border-radius:50%;filter:blur(90px);z-index:0;animation:fl 9s ease-in-out infinite}
.o1{width:380px;height:380px;background:rgba(212,175,55,0.06);top:-100px;right:-80px}
...
.card{background:var(--card);border:1px solid var(--border);border-radius:20px;padding:38px 34px 34px;backdrop-filter:blur(24px);box-shadow:0 0 80px rgba(212,175,55,0.06),0 20px 60px rgba(0,0,0,.5)}
.brand{display:flex;align-items:center;gap:14px;margin-bottom:28px}
.brand-img{width:48px;height:48px;border-radius:50%;overflow:hidden;border:1px solid var(--border);box-shadow:0 0 20px rgba(212,175,55,0.35),0 0 12px rgba(212,175,55,0.2);flex-shrink:0}
...
.hint{display:flex;align-items:center;gap:10px;background:rgba(212,175,55,0.07);border:1px solid rgba(212,175,55,0.15);border-radius:10px;padding:10px 14px;margin-bottom:20px}
.hint-label{font-size:11px;color:var(--dim);flex:1}
.hint-val{font-family:ui-monospace,monospace;font-size:14px;font-weight:700;color:var(--accent);background:rgba(212,175,55,0.1);border:1px solid rgba(212,175,55,0.25);padding:3px 11px;border-radius:7px;cursor:pointer;transition:.15s;letter-spacing:.08em}
.hint-val:hover{background:rgba(212,175,55,0.22)}
...
input[type=password]:focus{border-color:rgba(212,175,55,.55);background:rgba(0,0,0,.4);box-shadow:0 0 0 3px rgba(212,175,55,.1)}
...
.btn{width:100%;padding:13px;border-radius:11px;border:none;cursor:pointer;background:linear-gradient(135deg,#D4AF37,#B8941E);color:#fff;font-family:inherit;font-size:14px;font-weight:600;display:flex;align-items:center;justify-content:center;gap:8px;box-shadow:0 4px 20px rgba(212,175,55,.35);transition:.2s;position:relative;overflow:hidden}
...
:root{
  ...
  --card:#14141f;--card-b:rgba(212,175,55,0.15);--card-bh:rgba(212,175,55,0.35);
  --accent:#D4AF37;--accent2:#F0D060;--accent-d:rgba(212,175,55,0.12);
  --green:#50C878;--green-bg:rgba(80,200,120,0.1);--green-t:#70E898;
  --red:#FF4444;--red-bg:rgba(255,68,68,0.1);--red-t:#FF7777;
  --amber:#FFB020;--amber-bg:rgba(255,176,32,0.1);--amber-t:#FFD060;
  --purple:#C9A0FF;--purple-bg:rgba(201,160,255,0.1);
  --t1:#F5F0E0;--t2:#B0A880;--t3:#706840;
  --sidebar-w:248px;--radius:16px;
  --shadow:0 4px 24px rgba(0,0,0,0.5);
}
[data-theme="light"]{
  --bg:#FAF8F0;--bg2:#F0EDE0;--bg3:#E8E4D0;
  --card:#FFFFFF;--card-b:rgba(180,150,40,0.2);--card-bh:rgba(180,150,40,0.4);
  --accent:#B8941E;--accent2:#8B6914;--accent-d:rgba(184,148,30,0.08);
  --green:#2D8B57;--green-bg:rgba(45,139,87,0.08);--green-t:#1A6B3A;
  --red:#CC2222;--red-bg:rgba(204,34,34,0.08);--red-t:#991111;
  --amber:#B8860B;--amber-bg:rgba(184,134,11,0.08);--amber-t:#8B6508;
  --purple:#7B5FC0;--purple-bg:rgba(123,95,192,0.08);
  --purple-t:#5A3FA0;
  --t1:#1A1A0F;--t2:#4A4530;--t3:#8A8060;
...
.logo-img{width:38px;height:38px;border-radius:50%;overflow:hidden;border:1px solid var(--card-b);box-shadow:0 0 14px rgba(212,175,55,.3),0 0 8px rgba(212,175,55,.25);flex-shrink:0}
...
.nav-badge{margin-right:auto;background:rgba(212,175,55,0.15);color:var(--accent2);font-size:9px;padding:1px 6px;border-radius:20px;font-weight:700}
.sb-foot{padding:12px 14px;border-top:1px solid var(--card-b)}
.tg-btn{display:flex;align-items:center;justify-content:center;gap:8px;background:linear-gradient(135deg,#D4AF37,#B8941E);color:#fff;border-radius:9px;padding:10px;font-size:12.5px;font-weight:600;font-family:inherit;border:none;cursor:pointer;width:100%;transition:.15s}
...
.mob-logo{width:28px;height:28px;border-radius:50%;overflow:hidden;box-shadow:0 0 8px rgba(212,175,55,.35)}
...
.traf-range-tab.on{background:var(--accent);color:#fff;box-shadow:0 2px 8px rgba(212,175,55,.35)}
...
.btn-p{background:linear-gradient(135deg,#D4AF37,#B8941E);color:#fff;box-shadow:0 2px 14px rgba(212,175,55,.35)}
.btn-p:hover{background:#B8941E;box-shadow:0 4px 18px rgba(212,175,55,.4)}
.btn-o{background:transparent;border:1px solid var(--card-b);color:var(--t2)}
.btn-o:hover{background:var(--accent-d);border-color:rgba(212,175,55,.3)}
.btn-g{background:var(--accent-d);color:var(--accent2);border:1px solid rgba(212,175,55,.15)}
.btn-g:hover{background:rgba(212,175,55,.22)}
.btn-d{background:var(--red-bg);color:var(--red-t);border:1px solid rgba(239,68,68,.2)}
.btn-d:hover{background:rgba(239,68,68,.2)}
.btn-pur{background:var(--purple-bg);color:#C9A0FF;border:1px solid rgba(201,160,255,.2)}
.btn-pur:hover{background:rgba(201,160,255,.22)}
.btn-amber{background:var(--amber-bg);color:var(--amber-t);border:1px solid rgba(255,176,32,.2)}
.btn-amber:hover{background:rgba(255,176,32,.22)}
...
.sr{display:flex;align-items:center;justify-content:space-between;padding:9px 0;border-bottom:1px solid rgba(212,175,55,0.05);font-size:12px}
...
.fi:focus,.fs:focus{border-color:rgba(212,175,55,.45);background:rgba(0,0,0,.25);box-shadow:0 0 0 3px rgba(212,175,55,.08)}
.fs option{background:var(--bg2)}
[data-theme="light"] .fs option{background:#fff}
.cl{background:var(--accent-d);border:1px solid rgba(212,175,55,.15);border-radius:10px;padding:11px 13px;font-size:11px;color:var(--t2);display:flex;gap:9px;align-items:flex-start;line-height:1.8;margin-top:12px}
...
.cp-head-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 18px rgba(212,175,55,.35)}
...
.cp-input-full:focus{border-color:rgba(212,175,55,.5);box-shadow:0 0 0 3px rgba(212,175,55,.1)}
...
.chip:hover{background:rgba(212,175,55,.18);color:var(--accent2)}
.chip.active{background:var(--accent);color:#fff;border-color:var(--accent);box-shadow:0 3px 10px rgba(212,175,55,.35)}
...
.proto-card.active{border-color:var(--accent);background:var(--accent-d);box-shadow:0 0 0 3px rgba(212,175,55,.1)}
...
.cp-submit-btn{background:linear-gradient(135deg,var(--accent),var(--accent2));color:#fff;border:none;border-radius:13px;padding:13px 26px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 20px rgba(212,175,55,.35);transition:.18s;white-space:nowrap}
.cp-submit-btn:hover{transform:translateY(-2px);box-shadow:0 10px 26px rgba(212,175,55,.45)}
...
.srv-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 18px rgba(212,175,55,.35)}
...
.modal-v2-hint{background:rgba(212,175,55,.08);border:1px solid rgba(212,175,55,.18);border-radius:11px;padding:9px 12px;font-size:10px;color:var(--t2);display:flex;gap:7px;align-items:flex-start;line-height:1.6;margin-top:2px}
...
.lmodal-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;flex-shrink:0;box-shadow:0 6px 16px rgba(212,175,55,.35)}
...
.lmodal-search input:focus{border-color:rgba(212,175,55,.5);box-shadow:0 0 0 3px rgba(212,175,55,.1)}
...
.lmodal-qbtn:hover{background:rgba(212,175,55,.2)}
...
.lrow-v2.checked{background:rgba(212,175,55,.1);border-color:rgba(212,175,55,.25)}
...
.lrow{display:flex;align-items:center;gap:8px;padding:7px 0;border-bottom:1px solid rgba(212,175,55,.05)}
...
.cfg-uuid-mini:hover{background:rgba(212,175,55,.2)}
...
.log-item{display:flex;gap:12px;padding:11px 0;border-bottom:1px solid rgba(212,175,55,.05);position:relative}
...
.erow{padding:9px 0;border-bottom:1px solid rgba(212,175,55,.05)}
...
.brand-img{{width:40px;height:40px;border-radius:50%;overflow:hidden;border:1px solid var(--card-b);box-shadow:0 0 14px rgba(139,92,246,.3),0 0 8px rgba(212,175,55,.25);flex-shrink:0}}
.brand-img img{{width:100%;height:100%;object-fit:cover}}
